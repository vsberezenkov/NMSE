...
partial class StarshipPanel
{
    ...
    private void SetupLayout()
    {
        ...
        _deleteBtn = new Button { Text = "Delete Ship", Width = 76 };
        _deleteBtn.Click += OnDeleteShip;
        _exportBtn = new Button { Text = "Export Starship", Width = 70 };
        _exportBtn.Click += OnExportShip;
        _importBtn = new Button { Text = "Import Starship", Width = 70 };
        _importBtn.Click += OnImportShip;
        _exportCorvetteBtn = new Button { Text = "Export Corvette", Width = 100, Visible = false };
        _exportCorvetteBtn.Click += OnExportCorvette;
        _importCorvetteBtn = new Button { Text = "Import Corvette", Width = 100, Visible = false };
        ...
        _snapshotTechBtn = new Button { Text = "Snapshot Tech", Width = 100, Visible = false };
        _snapshotTechBtn.Click += OnSnapshotTech;
        _importSnapshotBtn = new Button { Text = "Import Snapshot", Width = 100, Visible = false };
